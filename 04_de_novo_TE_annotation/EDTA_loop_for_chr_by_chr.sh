...
genome_pair="/home/kaedeh/scratch/paired_genome_done_syri/Acer_genome"
...
perl /home/kaedeh/projects/def-gowens/kaedeh/cranberry_genome/bin/EDTA/EDTA_raw.pl \
...
cat All_chr_EDTA.TEanno.bed | perl /home/kaedeh/projects/def-gowens/kaedeh/cranberry_genome/bin/replace_contig_names.pl *_chrnames_to_replace.txt > All_chr_names_fixed_EDTA.TEanno.bed
