...
#WARNING: 
#Merge CDS or TE features before doing bedtools intersect so that there is no duplicates/isoforms that could lead to overrepresentation.
...
cut -f 1-3 *cds.bed
cut -f 1-3 *_refgenome_chr.fa.mod.EDTA.TEanno.bed > genome_${genus}_TE.bed
